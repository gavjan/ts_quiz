...
function load_question(q) {
    let question_text = document.getElementById("quiz_question");
    let penalty_text = document.getElementById("penalty_text");
...
function update_page_button() {
    let next_button = document.getElementById("next_question_button");
    let prev_button = document.getElementById("prev_question_button");
